...
while line != final_size:
    ...
    if not agent_pos_n1_new_row.size == 0:
        ...
        if 0.25 < (line + 1) / final_size <=0.5 and (tasks_state_1_new_row[0] == 0 or tasks_state_1_new_row[0] == 1):
        ...
        if 0.5 < (line + 1) / final_size <= 0.75 and (tasks_state_1_new_row[0] == 0 or tasks_state_1_new_row[0] == 2):
        ...
        if 0.75 < (line + 1) / final_size and tasks_state_1_new_row[0] != 3:
...
path = 'Experience/DataSet_01_06_No1_tensors.pth'

...
class MultiAgentTrainingEnv_2D_v3:

    def __init__(self, width=10.0, height=10.0, agent_init_pos=None, agent_radius=None, obstacle_pos=None,
                 obstacle_radius=None, task_pos=None, task_radius=None, accuracy=0.1, multi_step=10, gamma=0.95):
        """
        2D 离散多智能体训练环境
        Attributes:
            width (int): 环境宽度。
        ...
        self.reward_finish_task = 10                  # self.reward_finish_task：完成某个任务后持续获得的reward
    ...
    def calculate_reward(self):
        ...
        if not self.done:
            ...
            # print("min_dis_agent2unfinished_task:\n", min_dis_agent2unfinished_task)
            self.immediate_reward += -1.0 * min_dis_agent2unfinished_task

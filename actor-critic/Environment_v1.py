...
class MultiAgentTrainingEnv_2D_v0:
    ...
    def calculate_reward(self):
        ...
        if not self.done:
            ...
            # print(dis_agent2selected_task)
            self.immediate_reward += -0.25 * dis_agent2selected_task
    ...
    def step(self):
        ...
        if if_trajectory_reward:
            ...
            # print(self.agent_action_memory[0])
            # print(self.task_pos.flatten().shape)
            return (self.agent_pos_memory[0], self.agent_pos_memory[-1], np.hstack((self.task_pos.flatten(), task_state_1_decimal)),
                    np.hstack((self.task_pos.flatten(), task_state_n1_decimal)), self.agent_action_memory[0], self.trajectory_reward.T)
